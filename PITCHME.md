...
<div style="position:relative;height:0;padding-bottom:81.97%;overflow:hidden;"><center><iframe style="position:absolute;top:0;left:0;width:50%;height:50%;" src="https://makecode.microbit.org/---run?id=_DELXbrcy1ehD" allowfullscreen="allowfullscreen" sandbox="allow-popups allow-forms allow-scripts allow-same-origin" frameborder="0"></iframe></center></div>
---
### ヒント
